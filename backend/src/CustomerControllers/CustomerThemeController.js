 ...
 * This is a duplicate of AdminThemeController but for customer routes
 */
const getThemeCSS = async (_req, res) => {
  try {
    console.log('Theme CSS endpoint called from customer controller');
...
:root {
  ...
  --card-text: ${cssVars['--card-text'] || '#333333'};     /* Card text */
