    ...
    <div className="mobile-header">
      ...
      <Offcanvas show={show} onHide={closeSidebar} className="mobile-sidebar">
        ...
        <Offcanvas.Body className="SideBar-Container">
          ...
          >
            <FaCog size={22} color={active === "admin-controls" ? "white" : "black"} />
          ...
          <Nav className="flex-column">
            <button
              type="button"
              className={`menu-toggle btn btn-link text-start ${
                active === "category" || active === "daily-offers" || active === "image-uploads" ? "active" : ""
              }`}
            ...
            >
              ...
              >
                <path
                  ...
                  fill={active === "category" || active === "daily-offers" || active === "image-uploads" ? "white" : "black"}
                />
              </svg>
            ...
            <Collapse in={menuOpen}>
              <div className="menu-sub-items ms-3">
                ...
                <Nav.Link
                  href="#"
                  className={active === "daily-offers" ? "active" : ""}
                  onClick={(e) => {
                    e.preventDefault();
                ...
                <Nav.Link
                  href="#"
                  className={active === "image-uploads" ? "active" : ""}
                  onClick={(e) => {
                    e.preventDefault();
